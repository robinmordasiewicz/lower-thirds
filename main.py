...
def create_and_download_lower_thirds(request: LowerThirdsRequest):
    ...
    # Generate the webm file for lower thirds
    replacements = {
        "Firstname Lastname": request.full_name,
        "Job Title": request.job_title,
        "Company": request.company_name
    }
    output_path = generate_webm_file(MLT_LOWER_THIRDS_TEMPLATE_PATH, replacements, request.filename)
...
def create_and_download_eyebrow(request: EyebrowRequest):
    ...
    # Generate the webm file for eyebrow
    replacements = {
